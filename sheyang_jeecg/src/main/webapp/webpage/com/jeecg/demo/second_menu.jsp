...
<body onload="option()">
<select id="select" name="select" style="width: 100px;height: 25px">
</select>
<button type="button" onclick="select()">提交</button>
<hr>
...
<script type="text/javascript">
    ...
    function select() {
        ...
        fatie(sel_obj.options[index].value);
    }
            ...
            success: function(json) {
                ...
                for(var i=0;i<t.length;i++)
                {
                    ...
                    for(var j=0;j<t1.length;j++)
                    {
                        ...
                        if(i==0&&j==0)
                        {member(width/2+j*width-50, 20, '', '射阳县安全生产监管二级网格图', 'male.png', '#ffffff', '#000000',"",i,40);}
