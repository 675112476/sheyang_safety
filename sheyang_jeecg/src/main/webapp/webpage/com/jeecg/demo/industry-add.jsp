...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="industryController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="industryName" name="industryName" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="*" ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
							<input id="industryFenguan" name="industryFenguan" type="text" style="width: 150px" class="searchbox-inputtext"  datatype="*" ignore="ignore"   onclick="popupClick(this,'leader_name','industryFenguan','fenguan')"  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							<input id="industryJuzhang" name="industryJuzhang" type="text" style="width: 150px" class="searchbox-inputtext"  datatype="*" ignore="ignore"   onclick="popupClick(this,'leader_name','industryJuzhang','juzhang')"  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="height:auto;width:95%" class="inputxt" rows="6" id="industryIntroduction" name="industryIntroduction"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
