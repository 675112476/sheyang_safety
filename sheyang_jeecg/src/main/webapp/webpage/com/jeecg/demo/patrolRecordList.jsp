...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="patrolRecordList" checkbox="false" pagination="true"
			fitColumns="true" title="巡查记录" sortName="createDate"
			actionUrl="patrolRecordController.do?datagrid" idField="id"
			...
			<t:dgCol title="巡查员姓名" field="patrolName" query="true"
				queryMode="single"
				dictionary="xunchayuan,patrolName@telephone,realname@telephone"
				popup="true" width="120"></t:dgCol>
			<t:dgCol title="巡查员电话" field="telephone" queryMode="single"
				width="120"></t:dgCol>
			...
			<t:dgCol title="整改措施" field="record" query="true" queryMode="single"
				width="350"></t:dgCol>
			<t:dgCol title="风险点是否可控" field="iscontrol" query="true"
				queryMode="single" dictionary="yes_or_no" width="120"></t:dgCol>
...
<script type="text/javascript">
	...
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'patrolRecordController.do?upload',
				"patrolRecordList");
	}

	//导出
	function ExportXls() {
		JeecgExcelExport("patrolRecordController.do?exportXls",
				"patrolRecordList");
	}

	//模板下载
	function ExportXlsByT() {
		JeecgExcelExport("patrolRecordController.do?exportXlsByT",
				"patrolRecordList");
	}
