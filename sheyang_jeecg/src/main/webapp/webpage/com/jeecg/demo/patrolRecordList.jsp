...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="patrolRecordList" checkbox="false" pagination="true" fitColumns="true" title="巡查记录" sortName="createDate" actionUrl="patrolRecordController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="巡查公司"  field="factoryName"  queryMode="single"  dictionary="patrol_factory,factoryName,factory"  popup="true"  width="120"></t:dgCol>
   <t:dgCol title="整改措施"  field="record"  query="true"  queryMode="single"  width="350"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="patrolRecordController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="patrolRecordController.do?goAdd" funname="add"></t:dgToolBar>
	<t:dgToolBar title="编辑" icon="icon-edit" url="patrolRecordController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="patrolRecordController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="patrolRecordController.do?goUpdate" funname="detail"></t:dgToolBar>
